...
function showNotification(e) {
    ...
    if (targetElement.classList.contains('pricing-section__button')) {
        ...
        switch (notificationType) {
            case 'free': {
                var notification = new Notification('error', 'ERROR', 'Try again', 15000);
                break;
            }

            case 'professional': {
                var notification = new Notification('success', 'successful', 'Congratulation!', 15000);
                break;
            }

            case 'business': {
                var notification = new Notification('warning', 'warning', 'Сheck you mail', 15000);
                break;
            }

            case 'business+': {
                var notification = new Notification('info', 'Information', 'For business partners only', 15000);
                break;
            }
        }
